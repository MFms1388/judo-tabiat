...
async function loadCoachAthletes() {
  ...
  console.log(
    "🔵 شروع دریافت ورزشکاران از Supabase..."
  );
...
async function initializeCoach() {
  ...
  if (coachInitialized) {
    ...
    console.log(
      "ℹ️ Coach panel قبلاً initialize شده."
    );
  ...
  try {
    ...
    await loadCoachEmail();


    // --------------------------------------------------------
    // 7. حضور و غیاب اگر صفحه فعال است
    // --------------------------------------------------------
